...
def GetStocks():
    ...
    train_price =[]
    for stock in stocks:
        new_train_data, new_train_price = get_data(stock, datetime(2011,1,1), datetime(2011,1,15))
    ...
    x_amount = 15
    x_arrays, y_results = ParseArray(test_data, x_dim, x_amount)
