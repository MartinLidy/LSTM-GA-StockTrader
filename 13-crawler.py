...
crawler1 = SimpleCrawler1(links=["http://www.marketwatch.com/"], domains=["com"], delay=0.0)
...
crawler2 = SimpleCrawler1(links=["http://www.marketwatch.com/"], domains=["com"], delay=10)
